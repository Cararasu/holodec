...
//sw,cw,tw,fp_ip,...
	...
	},
	{
		...
		{X86_INS_CMOVE,	{"cmovz", {{2, "=(#arg[1],?($zf,#arg[1],#arg[2]))"}}, H_INSTR_TYPE_MOV, H_INSTR_TYPE_UNKNOWN, H_INSTR_COND_E}},

		{X86_INS_CMOVNE, {"cmovne", {{2, "=(#arg[1],?(#not($zf),#arg[1],#arg[2]))"}}, H_INSTR_TYPE_MOV, H_INSTR_TYPE_UNKNOWN, H_INSTR_COND_NE}},

		{X86_INS_CMOVA,	{"cmova", {{2, "=(#arg[1],?(#and($cf,$zf),#arg[1],#arg[2]))"}}, H_INSTR_TYPE_MOV, H_INSTR_TYPE_UNKNOWN, H_INSTR_COND_A}},

		{X86_INS_CMOVBE, {"cmovbe", {{2, "=(#arg[1],?(#or($cf,$zf),#arg[1],#arg[2]))"}}, H_INSTR_TYPE_MOV, H_INSTR_TYPE_UNKNOWN, H_INSTR_COND_BE}},

		{X86_INS_CMOVG,	{"cmovg", {{2, "=(#arg[1],?(#and(#not($zf),==($sf,$of)),#arg[1],#arg[2]))"}}, H_INSTR_TYPE_MOV, H_INSTR_TYPE_UNKNOWN, H_INSTR_COND_G}},

		{X86_INS_CMOVGE, {"cmovge", {{2, "=(#arg[1],?(==($sf,$of),#arg[1],#arg[2]))"}}, H_INSTR_TYPE_MOV, H_INSTR_TYPE_UNKNOWN, H_INSTR_COND_GE}},

		{X86_INS_CMOVL,	{"cmovge", {{2, "=(#arg[1],?(<>($sf,$of),#arg[1],#arg[2]))"}}, H_INSTR_TYPE_MOV, H_INSTR_TYPE_UNKNOWN, H_INSTR_COND_L}},
		{X86_INS_CMOVLE,	{"cmovle", {{2,  "=(#arg[1],?(#or($zf,<>($sf,$of)),#arg[1],#arg[2]))"}}, H_INSTR_TYPE_MOV, H_INSTR_TYPE_UNKNOWN, H_INSTR_COND_LE}},
		...
		{X86_INS_CMOVB,	{"cmovb", {{2,  "=(#arg[1],?($cf,#arg[1],#arg[2]))"}}, H_INSTR_TYPE_MOV, H_INSTR_TYPE_UNKNOWN, H_INSTR_COND_B}},

		{X86_INS_CMOVAE,	{"cmovae", {{2, "=(#arg[1],?(#not($cf),#arg[1],#arg[2]))"}}, H_INSTR_TYPE_MOV, H_INSTR_TYPE_UNKNOWN, H_INSTR_COND_AE}},

		{X86_INS_CMOVO,	{"cmovo", {{2, "=(#arg[1],?($of,#arg[1],#arg[2]))"}}, H_INSTR_TYPE_MOV, H_INSTR_TYPE_UNKNOWN, H_INSTR_COND_O}},

		{X86_INS_CMOVNO,	{"cmovno", {{2, "=(#arg[1],?(#not($of),#arg[1],#arg[2])) "}}, H_INSTR_TYPE_MOV, H_INSTR_TYPE_UNKNOWN, H_INSTR_COND_NO}},

		{X86_INS_CMOVS,	{"cmovs", {{2, "=(#arg[1],?($sf,#arg[1],#arg[2]))"}}, H_INSTR_TYPE_MOV, H_INSTR_TYPE_UNKNOWN, H_INSTR_COND_NEG}},

		{X86_INS_CMOVNS,	{"cmovns", {{2, "=(#arg[1],?(#not($sf),#arg[1],#arg[2]))"}}, H_INSTR_TYPE_MOV, H_INSTR_TYPE_UNKNOWN, H_INSTR_COND_POS}},

		{X86_INS_CMOVP,	{"cmovp", {{2, "=(#arg[1],?($pf,#arg[1],#arg[2]))"}}, H_INSTR_TYPE_MOV, H_INSTR_TYPE_UNKNOWN, H_INSTR_COND_UNK}},

		{X86_INS_CMOVNP,	{"cmovp", {{2, "=(#arg[1],?($pf,#arg[1],#arg[2]))"}}, H_INSTR_TYPE_MOV, H_INSTR_TYPE_UNKNOWN, H_INSTR_COND_UNK}},

		{X86_INS_JMP,		{"jmp", {{1, "#jmp(#arg[1])"}}, H_INSTR_TYPE_JMP, H_INSTR_TYPE_UNKNOWN, H_INSTR_COND_TRUE}},

		{X86_INS_JE,		{"je", {{1, "?(#not($zf),#jmp(#arg[1]))"}}, H_INSTR_TYPE_JMP, H_INSTR_TYPE_UNKNOWN, H_INSTR_COND_E}},

		{X86_INS_JNE,		{"jne", {{1, "?($zf,#jmp(#arg[1]))"}}, H_INSTR_TYPE_JMP, H_INSTR_TYPE_UNKNOWN, H_INSTR_COND_NE}},

		{X86_INS_JA,		{"ja", {{1, "?(#not(#and($cf,$zf)),#jmp(#arg[1]))"}}, H_INSTR_TYPE_JMP, H_INSTR_TYPE_UNKNOWN, H_INSTR_COND_A}},

		{X86_INS_JAE,		{"jae", {{1, "?($cf,#jmp(#arg[1]))"}}, H_INSTR_TYPE_JMP, H_INSTR_TYPE_UNKNOWN, H_INSTR_COND_AE}},

		{X86_INS_JB,		{"jb", {{1, "?(#not($cf),#jmp(#arg[1]))"}}, H_INSTR_TYPE_JMP, H_INSTR_TYPE_UNKNOWN, H_INSTR_COND_B}},

		{X86_INS_JBE,		{"jbe", {{1, "?(#not(#or($cf,$zf)),#jmp(#arg[1]))"}}, H_INSTR_TYPE_JMP, H_INSTR_TYPE_UNKNOWN, H_INSTR_COND_BE}},

		{X86_INS_JG,		{"jg", {{1, "?(#not(#and(#not($zf),==($sf,$of))),#jmp(#arg[1]))"}}, H_INSTR_TYPE_JMP, H_INSTR_TYPE_UNKNOWN, H_INSTR_COND_G}},

		{X86_INS_JGE,		{"jge", {{1, "?(#not(==($sf,$of)),#jmp(#arg[1]))"}}, H_INSTR_TYPE_JMP, H_INSTR_TYPE_UNKNOWN, H_INSTR_COND_GE}},

		{X86_INS_JL,		{"jl", {{1, "?(==($sf,$of),#jmp(#arg[1]))"}}, H_INSTR_TYPE_JMP, H_INSTR_TYPE_UNKNOWN, H_INSTR_COND_L}},

		{X86_INS_JLE,		{"jle", {{1, "?(#not(#or($zf,<>($sf,$of))),#jmp(#arg[1]))"}}, H_INSTR_TYPE_JMP, H_INSTR_TYPE_UNKNOWN, H_INSTR_COND_LE}},

		{X86_INS_JO,		{"jo", {{1, "?(#not($of),#jmp(#arg[1]))"}}, H_INSTR_TYPE_JMP, H_INSTR_TYPE_UNKNOWN, H_INSTR_COND_O}},

		{X86_INS_JNO,		{"jno", {{1, "?($of,#jmp(#arg[1]))"}}, H_INSTR_TYPE_JMP, H_INSTR_TYPE_UNKNOWN, H_INSTR_COND_NO}},

		{X86_INS_JS,		{"js", {{1, "?(#not($sf),#jmp(#arg[1]))"}}, H_INSTR_TYPE_JMP, H_INSTR_TYPE_UNKNOWN, H_INSTR_COND_NEG}},

		{X86_INS_JNS,		{"jns", {{1, "?($sf,#jmp(#arg[1]))"}}, H_INSTR_TYPE_JMP, H_INSTR_TYPE_UNKNOWN, H_INSTR_COND_POS}},

		{X86_INS_JP,		{"jp", {{1, "?(#not($pf),#jmp(#arg[1]))"}}, H_INSTR_TYPE_JMP, H_INSTR_TYPE_UNKNOWN, H_INSTR_COND_UNK}},

		{X86_INS_JNP,		{"jnp", {{1, "?($pf,#jmp(#arg[1]))"}}, H_INSTR_TYPE_JMP, H_INSTR_TYPE_UNKNOWN, H_INSTR_COND_UNK}},

		{X86_INS_JCXZ,	{"jcxz", {{1, "?(<>($cx,0),#jmp(#arg[1]))"}}, H_INSTR_TYPE_JMP, H_INSTR_TYPE_CMP, H_INSTR_COND_E}},
		{X86_INS_JECXZ,	{"jecxz", {{1, "?(<>($ecx,0),#jmp(#arg[1]))"}}, H_INSTR_TYPE_JMP, H_INSTR_TYPE_CMP, H_INSTR_COND_E}},
		{X86_INS_JRCXZ,	{"jrcxz", {{1, "?(<>($rcx,0),#jmp(#arg[1]))"}}, H_INSTR_TYPE_JMP, H_INSTR_TYPE_CMP, H_INSTR_COND_E}},
		...
		//X86_INS_CMPXCHG16B,
		{
			X86_INS_CMPXCHG,	{
				"cmpxchg", {
					{2, "==(#bsize(#arg[1]),8)", "#seq(=($zf,==($al,#arg[1])),=($cf,#c),=($pf,#p),=($af,#a),=($sf,#s),=($of,#o),?($zf,=(#arg[1],$al),=(#arg[1],#arg[2])))"},
					{2, "==(#bsize(#arg[1]),16)", "#seq(=($zf,==($al,#arg[1])),=($cf,#c),=($pf,#p),=($af,#a),=($sf,#s),=($of,#o),?($zf,=(#arg[1],$ax),=(#arg[1],#arg[2])))"},
					{2, "==(#bsize(#arg[1]),32)", "#seq(=($zf,==($eax,#arg[1])),=($cf,#c),=($pf,#p),=($af,#a),=($sf,#s),=($of,#o),?($zf,=(#arg[1],$eax),=(#arg[1],#arg[2])))"},
		...
		},
		{
			X86_INS_CMPXCHG8B, {
				"cmpxchg8g", {
					{2, "#seq(=($zf,==(#app($eax,$edx),#arg[1])),?($zf,#seq(=($eax,#arg[1][0,32]),=($edx,#arg[1][32,32])),=(#arg[1],#app($ebx,$ecx))))"}
				}, H_INSTR_TYPE_XCHG, H_INSTR_TYPE_UNKNOWN, H_INSTR_COND_E
			}
		},
		{
			X86_INS_CMPXCHG16B, {
				"cmpxchg16g", {
					{2, "#seq(=($zf,==(#app($rax,$rdx),#arg[1])),?($zf,#seq(=($rax,#arg[1][0,64]),=($rdx,#arg[1][64,64])),=(#arg[1],#app($rbx,$rcx))))"}
				}, H_INSTR_TYPE_XCHG, H_INSTR_TYPE_UNKNOWN, H_INSTR_COND_E
			}
		},
		...
		{X86_INS_RET,		{"ret", {{0, "#ret"}, {1, "#seq(#pop($mem,#arg[1]),#ret)"}}, H_INSTR_TYPE_RET, H_INSTR_TYPE_UNKNOWN, H_INSTR_COND_TRUE}},
		{X86_INS_IRET, {"iret", {{0, "#ret"}, {1, "#seq(#pop($mem,#arg[1]),#ret)"}}, H_INSTR_TYPE_RET, H_INSTR_TYPE_UNKNOWN, H_INSTR_COND_TRUE}},
		{X86_INS_IRETD, {"iretd", {{0, "#ret"}, {1, "#seq(#pop($mem,#arg[1]),#ret)"}}, H_INSTR_TYPE_RET, H_INSTR_TYPE_UNKNOWN, H_INSTR_COND_TRUE}},
		{X86_INS_IRETQ, {"iretq", {{0, "#ret"}, {1, "#seq(#pop($mem,#arg[1]),#ret)"}}, H_INSTR_TYPE_RET, H_INSTR_TYPE_UNKNOWN, H_INSTR_COND_TRUE}},
		{X86_INS_RETF, {"retf", {{0, "#ret"}, {1, "#seq(#pop($mem,#arg[1]),#ret)"}}, H_INSTR_TYPE_RET, H_INSTR_TYPE_UNKNOWN, H_INSTR_COND_TRUE}},
		{X86_INS_RETFQ, {"retfq", {{0, "#ret"}, {1, "#seq(#pop($mem,#arg[1]),#ret)"}}, H_INSTR_TYPE_RET, H_INSTR_TYPE_UNKNOWN, H_INSTR_COND_TRUE}},
...
//TODO flags undef checkpoint
		...
		{X86_INS_LOOP,	{"loop", {{1, "#seq(=($ecx,-($ecx,1)),?(#not($ecx),#rjmp(#arg[1])))"}}, H_INSTR_TYPE_JMP}},


		{X86_INS_LOOPE,	{"loope", {{1, "#seq(=($ecx,-($ecx,1)),?(#not(#and($ecx,$zf)),#rjmp(#arg[1])))"}}, H_INSTR_TYPE_JMP, H_INSTR_TYPE_UNKNOWN, H_INSTR_COND_E}},

		{X86_INS_LOOPNE, {"loopne", {{1, "#seq(=($ecx,-($ecx,1)),?(#not(#and($ecx,#not($zf))),#rjmp(#arg[1])))"}}, H_INSTR_TYPE_JMP, H_INSTR_TYPE_UNKNOWN, H_INSTR_COND_NE}},

		{X86_INS_CALL,	{"call", {{1, "#call(#arg[1])"}}, H_INSTR_TYPE_CALL}},

		{X86_INS_INT,	{"int", {{1, "#syscall(#arg[1])"}}, H_INSTR_TYPE_SYSCALL, H_INSTR_TYPE_UNKNOWN, H_INSTR_COND_TRUE}},
		{X86_INS_INTO,	{"into", {{"#syscall"}}, H_INSTR_TYPE_SYSCALL, H_INSTR_TYPE_UNKNOWN, H_INSTR_COND_TRUE}},

		{X86_INS_BOUND,	{"bound", {{2,"#seq(=(#t[1],#ld(#arg[2],#size(#arg[2]))),=(#t[2],#ld(+(#arg[2],#size(#arg[1])),#size(#arg[1]))),?(#not(#or(<(#arg[1],#t[1]),>(#arg[1],#t[2]))),#trap))"}}}},
		...
		{X86_INS_CMPSB | CUSOM_X86_INSTR_EXTR_REPE, {"repe cmpsb", {{2, "#rep(#and($rcx,$zf),#rec[scasb](#arg[1],#arg[2]))"}}, H_INSTR_TYPE_CMP, H_INSTR_TYPE_UNKNOWN, H_INSTR_COND_E}},
		{X86_INS_CMPSW | CUSOM_X86_INSTR_EXTR_REPE, {"repe cmpsw", {{2, "#rep(#and($rcx,$zf),#rec[scasw](#arg[1],#arg[2]))"}}, H_INSTR_TYPE_CMP, H_INSTR_TYPE_UNKNOWN, H_INSTR_COND_E}},
		{X86_INS_CMPSD | CUSOM_X86_INSTR_EXTR_REPE, {"repe cmpsd", {{2, "#rep(#and($rcx,$zf),#rec[scasd](#arg[1],#arg[2]))"}}, H_INSTR_TYPE_CMP, H_INSTR_TYPE_UNKNOWN, H_INSTR_COND_E}},
		{X86_INS_CMPSQ | CUSOM_X86_INSTR_EXTR_REPE, {"repe cmpsq", {{2, "#rep(#and($rcx,$zf),#rec[scasq](#arg[1],#arg[2]))"}}, H_INSTR_TYPE_CMP, H_INSTR_TYPE_UNKNOWN, H_INSTR_COND_E}},

		{X86_INS_CMPSB | CUSOM_X86_INSTR_EXTR_REPNE, {"repne cmpsb", {{2, "#rep(#and($rcx,#not($zf)),#rec[scasb](#arg[1],#arg[2]))"}}, H_INSTR_TYPE_CMP, H_INSTR_TYPE_UNKNOWN, H_INSTR_COND_NE}},
		{X86_INS_CMPSW | CUSOM_X86_INSTR_EXTR_REPNE, {"repne cmpsw", {{2, "#rep(#and($rcx,#not($zf)),#rec[scasw](#arg[1],#arg[2]))"}}, H_INSTR_TYPE_CMP, H_INSTR_TYPE_UNKNOWN, H_INSTR_COND_NE}},
		{X86_INS_CMPSD | CUSOM_X86_INSTR_EXTR_REPNE, {"repne cmpsd", {{2, "#rep(#and($rcx,#not($zf)),#rec[scasd](#arg[1],#arg[2]))"}}, H_INSTR_TYPE_CMP, H_INSTR_TYPE_UNKNOWN, H_INSTR_COND_NE}},
		{X86_INS_CMPSQ | CUSOM_X86_INSTR_EXTR_REPNE, {"repne cmpsq", {{2, "#rep(#and($rcx,#not($zf)),#rec[scasq](#arg[1],#arg[2]))"}}, H_INSTR_TYPE_CMP, H_INSTR_TYPE_UNKNOWN, H_INSTR_COND_NE}},
		...
		{X86_INS_SCASB | CUSOM_X86_INSTR_EXTR_REPE, {"repe scasb", {{2, "#rep(#and($rcx,$zf),#rec[scasb](#arg[1],#arg[2]))"}}, H_INSTR_TYPE_CMP, H_INSTR_TYPE_UNKNOWN, H_INSTR_COND_E}},
		{X86_INS_SCASW | CUSOM_X86_INSTR_EXTR_REPE, {"repe scasw", {{2, "#rep(#and($rcx,$zf),#rec[scasw](#arg[1],#arg[2]))"}}, H_INSTR_TYPE_CMP, H_INSTR_TYPE_UNKNOWN, H_INSTR_COND_E}},
		{X86_INS_SCASD | CUSOM_X86_INSTR_EXTR_REPE, {"repe scasd", {{2, "#rep(#and($rcx,$zf),#rec[scasd](#arg[1],#arg[2]))"}}, H_INSTR_TYPE_CMP, H_INSTR_TYPE_UNKNOWN, H_INSTR_COND_E}},
		{X86_INS_SCASQ | CUSOM_X86_INSTR_EXTR_REPE, {"repe scasq", {{2, "#rep(#and($rcx,$zf),#rec[scasq](#arg[1],#arg[2]))"}}, H_INSTR_TYPE_CMP, H_INSTR_TYPE_UNKNOWN, H_INSTR_COND_E}},

		{X86_INS_SCASB | CUSOM_X86_INSTR_EXTR_REPNE, {"repne scasb", {{2, "#rep(#and($rcx,#not($zf)),#rec[scasb](#arg[1],#arg[2]))"}}, H_INSTR_TYPE_CMP, H_INSTR_TYPE_UNKNOWN, H_INSTR_COND_NE}},
		{X86_INS_SCASW | CUSOM_X86_INSTR_EXTR_REPNE, {"repne scasw", {{2, "#rep(#and($rcx,#not($zf)),#rec[scasw](#arg[1],#arg[2]))"}}, H_INSTR_TYPE_CMP, H_INSTR_TYPE_UNKNOWN, H_INSTR_COND_NE}},
		{X86_INS_SCASD | CUSOM_X86_INSTR_EXTR_REPNE, {"repne scasd", {{2, "#rep(#and($rcx,#not($zf)),#rec[scasd](#arg[1],#arg[2]))"}}, H_INSTR_TYPE_CMP, H_INSTR_TYPE_UNKNOWN, H_INSTR_COND_NE}},
