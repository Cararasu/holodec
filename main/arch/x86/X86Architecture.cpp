...
holox86::Architecture holox86::x86architecture {"x86", "x86", 64, 8, {
	...
	},
	{
		...
		{0, "rflags", RegType::eFlag, nullptr, "rflags", 64, 0, false},
		{0, "eflags", RegType::eFlag, "rflags", "rflags", 32, 0, false},
		{0, "flags", RegType::eFlag, "eflags", "rflags", 16, 0, false},
		
		{0, "cf", RegType::eFlag, "flags", "rflags", 1, 0, false},
		{0, "pf", RegType::eFlag, "flags", "rflags", 1, 2, false},
		{0, "af", RegType::eFlag, "flags", "rflags", 1, 4, false},
		{0, "zf", RegType::eFlag, "flags", "rflags", 1, 6, false},
		{0, "sf", RegType::eFlag, "flags", "rflags", 1, 7, false},
		{0, "tf", RegType::eFlag, "flags", "rflags", 1, 8, false},
		{0, "if", RegType::eFlag, "flags", "rflags", 1, 9, false},
		{0, "df", RegType::eFlag, "flags", "rflags", 1, 10, false},
		{0, "of", RegType::eFlag, "flags", "rflags", 1, 11, false},
		{0, "iopl", RegType::eFlag, "flags", "rflags", 1, 12, false},
		{0, "nt", RegType::eFlag, "flags", "rflags", 1, 14, false},
		
		{0, "rf", RegType::eFlag, "eflags", "rflags", 1, 16, false},
		{0, "vm", RegType::eFlag, "eflags", "rflags", 1, 17, false},
		{0, "ac", RegType::eFlag, "eflags", "rflags", 1, 18, false},
		{0, "vif", RegType::eFlag, "eflags", "rflags", 1, 19, false},
		{0, "vip", RegType::eFlag, "eflags", "rflags", 1, 20, false},
		{0, "id", RegType::eFlag, "eflags", "rflags", 1, 21, false},
...
//sw,cw,tw,fp_ip,...
	...
	{},//instructionIds
	{
		...
		{X86_INS_MOVSXD, "movsxd", {{2, "=(#arg[1],#sext(#arg[2],#bsize(#arg[1])))"}}, InstructionType::eMov},
		...
		{X86_INS_CBW, "cbw", {{0, "=($ax,#sext($al,#bsize($ax)))"}}, InstructionType::eExtend},
		{X86_INS_CWDE, "cwde", {{0, "=($eax,#ext($ax,#bsize($eax)))"}}, InstructionType::eExtend},
		{X86_INS_CDQE, "cdqe", {{0, "=($rax,#sext($eax,#bsize($rax)))"}}, InstructionType::eExtend},

		{X86_INS_CWD, "cwd", {{0, "=($dx,#sext($ax,#bsize($dx)))"}}, InstructionType::eExtend},
		{X86_INS_CDQ, "cdq", {{0, "=($edx,#sext($eax,#bsize($edx)))"}}, InstructionType::eExtend},
		{X86_INS_CQO, "cqo", {{0, "=($rdx,#sext($rax,#bsize($rdx)))"}}, InstructionType::eExtend},
...
//TODO flags for rotates
		...
		{X86_INS_LAHF, "lahf", {{0, "=($ah,$eflags)"}}, InstructionType::eMov},
		{X86_INS_SAHF, "sahf", {{0, "=($eflags,$ah)"}}, InstructionType::eMov},

		{X86_INS_PUSHF, "pushf", {{0, "#rec[push]($flags)"}}, InstructionType::ePush},
		{X86_INS_PUSHFD, "pushfd", {{0, "#rec[push]($eflags)"}}, InstructionType::ePush},
		{X86_INS_PUSHFQ, "pushfq", {{0, "#rec[push]($rflags)"}}, InstructionType::ePush},

		{X86_INS_POPF, "popf", {{0, "#rec[pop]($flags)"}}, InstructionType::ePop},
		{X86_INS_POPFD, "popfd", {{0, "#rec[pop]($eflags)"}}, InstructionType::ePop},
		{X86_INS_POPFQ, "popfq", {{0, "#rec[pop]($rflags)"}}, InstructionType::ePop},
