...
Architecture holox86::x8664architecture{ "x86_64", "x86_64", 8, 8, 8, {
		[](Binary * binary) {
			static FunctionAnalyzer* analyzer = nullptr;
			if (analyzer == nullptr) {
				printf("Create New Object\n");
				analyzer = new holox86::X86FunctionAnalyzer(&holox86::x8664architecture);
			}
	...
	},
	{
		...
		*/
		...
		//sw,cw,tw,fp_ip,...
			...
			{X86_INS_JE, "je", {{2, "#jmp(#arg[1],$zf,#arg[2])"}}, InstructionType::eCJmp},
			{X86_INS_JNE, "jne", {{2, "#jmp(#arg[1],#not($zf),#arg[2])"}}, InstructionType::eCJmp},
			{X86_INS_JA, "ja", {{2, "#jmp(#arg[1],#not(#or($cf,$zf)),#arg[2])"}}, InstructionType::eCJmp},
			{X86_INS_JAE, "jae", {{2, "#jmp(#arg[1],#not($cf),#arg[2])"}}, InstructionType::eCJmp},
			{X86_INS_JB, "jb", {{2, "#jmp(#arg[1],#not($cf),#arg[2])"}}, InstructionType::eCJmp},
			{X86_INS_JBE, "jbe", {{2, "#jmp(#arg[1],#or($cf,$zf),#arg[2])"}}, InstructionType::eCJmp},
			{X86_INS_JG, "jg", {{2, "#jmp(#arg[1],#and(#not($zf),==($sf,$of)),#arg[2])"}}, InstructionType::eCJmp},
			{X86_INS_JGE, "jge", {{2, "#jmp(#arg[1],==($sf,$of),#arg[2])"}}, InstructionType::eCJmp},
			{X86_INS_JL, "jl", {{2, "#jmp(#arg[1],<>($sf,$of),#arg[2])"}}, InstructionType::eCJmp},
			{X86_INS_JLE, "jle", {{2, "#jmp(#arg[1],#or($zf,<>($sf,$of)),#arg[2])"}}, InstructionType::eCJmp},
			{X86_INS_JO, "jo", {{2, "#jmp(#arg[1],$of,#arg[2])"}}, InstructionType::eCJmp},
			{X86_INS_JNO, "jno", {{2, "#jmp(#arg[1],#not($of),#arg[2])"}}, InstructionType::eCJmp},
			{X86_INS_JS, "js", {{2, "#jmp(#arg[1],$sf,#arg[2])"}}, InstructionType::eCJmp},
			{X86_INS_JNS, "jns", {{2, "#jmp(#arg[1],#not($sf),#arg[2])"}}, InstructionType::eCJmp},

			{X86_INS_JP, "jp", {{2, "#jmp(#arg[1],$pf,#arg[2])"}}, InstructionType::eCJmp},
			{X86_INS_JNP, "jnp", {{2, "#jmp(#arg[1],#not($pf),#arg[2])"}}, InstructionType::eCJmp},

			{X86_INS_JCXZ, "jcxz", {{2, "#jmp(#arg[1],#not($cx),#arg[2])"}}, InstructionType::eCJmp},
			{X86_INS_JECXZ, "jecxz", {{2, "#jmp(#arg[1],#not($ecx),#arg[2])"}}, InstructionType::eCJmp},
			{X86_INS_JRCXZ, "jrcxz", {{2, "#jmp(#arg[1],#not($rcx),#arg[2])"}}, InstructionType::eCJmp},
			...
			{X86_INS_ADC, "adc", {{2, "#seq(=(#arg[1],+(#arg[1],#arg[2],$cf)),=($of,#o),=($cf,#c),=($af,#c(4)),=($zf,#and(==(#arg[1],0),$zf)),=($pf,$parity[u](#arg[1])),=($sf,<[s](#arg[1],0)))"}}, InstructionType::eAdd},

			{X86_INS_SUB, "sub", {{2, "#seq(=($zf,==(#arg[1],#arg[2])),=(#arg[1],-(#arg[1],#arg[2])),=($of,#o),=($cf,#c),=($af,#c(4)),=($pf,$parity[u](#arg[1])),=($sf,<[s](#arg[1],0)))"}}, InstructionType::eSub},
			{X86_INS_SBB, "sbb", {{2, "#seq(=(#arg[1],-(#arg[1],#arg[2],$cf)),=($of,#o),=($cf,#c),=($af,#c(4)),=($zf,#and(==(#arg[1],0),$zf)),=($pf,$parity[u](#arg[1])),=($sf,<[s](#arg[1],0)))"}}, InstructionType::eSub},

			{X86_INS_ADCX, "adcx", {{2, "#seq(=(#arg[1],+(#arg[1],#arg[2],$cf)),=($of,#o),=($cf,#c),=($af,#c(4)),=($pf,$parity[u](#arg[1])),=($sf,<[s](#arg[1],0)),=($zf,==(#arg[1],0)))"}}, InstructionType::eAdd},
			{X86_INS_ADOX, "adox", {{2, "#seq(=(#arg[1],+(#arg[1],#arg[2],$of)),=($of,#o),=($cf,#c),=($af,#c(4)),=($pf,$parity[u](#arg[1])),=($sf,<[s](#arg[1],0)),=($zf,==(#arg[1],0)))"}}, InstructionType::eAdd},
			...
			//TODO flags for rotates
					...
					{X86_INS_LOOP, "loop", {{1, "#seq(=($ecx,-($ecx,1)),#jmp(#arg[1],#not($ecx),#arg[2]))"}}, InstructionType::eCJmp},


					{X86_INS_LOOPE, "loope", {{1, "#seq(=($ecx,-($ecx,1)),#jmp(#arg[1],#not(#and($ecx,$zf)),#arg[2]))"}}, InstructionType::eCJmp},

					{X86_INS_LOOPNE, "loopne", {{1, "#seq(=($ecx,-($ecx,1)),#jmp(#arg[1],#not(#and($ecx,#not($zf))),#arg[2]))"}}, InstructionType::eCJmp},
...
Architecture holox86::x86architecture{ "x86", "x86", 8, 4, 4, {
		[](Binary * binary) {
			static FunctionAnalyzer* analyzer = nullptr;
			if (analyzer == nullptr) {
				printf("Create New Object\n");
	...
	{
		{0, "eax", RegType::eGPR, nullptr, "eax", 32, 0, true},
		{0, "ax", RegType::eGPR, "eax", "eax", 16, 0, false},
		{0, "al", RegType::eGPR, "ax", "eax", 8, 0, false},{0, "ah", RegType::eGPR, "ax", "eax", 8, 8, false},

		{0, "ebx", RegType::eGPR, nullptr, "ebx", 32, 0, true},
		{0, "bx", RegType::eGPR, "ebx", "ebx", 16, 0, false},
		{0, "bl", RegType::eGPR, "bx", "ebx", 8, 0, false},{0, "bh", RegType::eGPR, "bx", "ebx", 8, 8, false},

		{0, "ecx", RegType::eGPR, nullptr, "ecx", 32, 0, true},
		{0, "cx", RegType::eGPR, "ecx", "ecx", 16, 0, false},
		{0, "cl", RegType::eGPR, "cx", "ecx", 8, 0, false},{0, "ch", RegType::eGPR, "cx", "ecx", 8, 8, false},

		{0, "edx", RegType::eGPR, nullptr, "edx", 32, 0, true},
		{0, "dx", RegType::eGPR, "edx", "edx", 16, 0, false},
		{0, "dl", RegType::eGPR, "dx", "edx", 8, 0, false},{0, "dh", RegType::eGPR, "dx", "edx", 8, 8, false},

		{0, "ebp", RegType::eGPR, nullptr, "ebp", 32, 0, true},
		{0, "bp", RegType::eGPR, "ebp", "ebp", 16, 0, false},{0, "bpl", RegType::eGPR, "bp", "ebp", 8, 0, false},

		{0, "esi", RegType::eGPR, nullptr, "esi", 32, 0, true},
		{0, "si", RegType::eGPR, "esi", "esi", 16, 0, false},{0, "sil", RegType::eGPR, "si", "esi", 8, 0, false},

		{0, "edi", RegType::eGPR, nullptr, "edi", 32, 0, true},
		{0, "di", RegType::eGPR, "edi", "edi", 16, 0, false},{0, "dil", RegType::eGPR, "di", "edi", 8, 0, false},

		{0, "esp", RegType::eGPR, nullptr, "esp", 32, 0, true},
		{0, "sp", RegType::eGPR, "esp", "esp", 16, 0, false},{0, "spl", RegType::eGPR, "sp", "esp", 8, 0, true},

		{0, "eip", RegType::eGPR, nullptr, "eip", 32, 0, true},
		{0, "ip", RegType::eGPR, "eip", "eip", 16, 0, false},{0, "ipl", RegType::eGPR, "ip", "eip", 8, 0, false},
	...
	{X86_INS_PUSH, "push", {{1, "#seq(=($esp,-($esp,#size(#arg[1]))),#st($mem,+($esp,1),#arg[1]))"}}, InstructionType::ePush},
	{X86_INS_POP, "pop", {{1, "#seq(=(#arg[1],#ld($mem,+($esp,1),#size(#arg[1]))),=($esp,+($esp,#size(#arg[1]))))"}}, InstructionType::ePop},
	...
	/*
			...
			{X86_INS_LODSB, "lodsb", {{2, "#seq(=(#arg[1],#ld($mem,#arg[2],#size(#arg[2]))),?($df,=($edi,-($edi,1)),=($edi,+($edi,1))))"}}, InstructionType::eLoad},
			{X86_INS_LODSW, "lodsw", {{2, "#seq(=(#arg[1],#ld($mem,#arg[2],#size(#arg[2]))),?($df,=($edi,-($edi,2)),=($edi,+($edi,2))))"}}, InstructionType::eLoad},
			{X86_INS_LODSD, "lodsd", {{2, "#seq(=(#arg[1],#ld($mem,#arg[2],#size(#arg[2]))),?($df,=($edi,-($edi,4)),=($edi,+($edi,4))))"}}, InstructionType::eLoad},
			{X86_INS_LODSQ, "lodsq", {{2, "#seq(=(#arg[1],#ld($mem,#arg[2],#size(#arg[2]))),?($df,=($edi,-($edi,8)),=($edi,+($edi,8))))"}}, InstructionType::eLoad},

			{X86_INS_LODSB | CUSOM_X86_INSTR_EXTR_REP, "rep lodsb", {{2, "#rep($ecx,#seq(#rec[lodsb](#arg[1],#arg[2]),=($ecx,-($ecx,1))))"}}, InstructionType::eLoad},
			{X86_INS_LODSW | CUSOM_X86_INSTR_EXTR_REP, "rep lodsw", {{2, "#rep($ecx,#seq(#rec[lodsw](#arg[1],#arg[2]),=($ecx,-($ecx,1))))"}}, InstructionType::eLoad},
			{X86_INS_LODSD | CUSOM_X86_INSTR_EXTR_REP, "rep lodsd", {{2, "#rep($ecx,#seq(#rec[lodsd](#arg[1],#arg[2]),=($ecx,-($ecx,1))))"}}, InstructionType::eLoad},
			{X86_INS_LODSQ | CUSOM_X86_INSTR_EXTR_REP, "rep lodsq", {{2, "#rep($ecx,#seq(#rec[lodsq](#arg[1],#arg[2]),=($ecx,-($ecx,1))))"}}, InstructionType::eLoad},

			{X86_INS_STOSB, "stosb", {{2, "#seq(#st($mem,#arg[2],#arg[1]),?($df,=($edi,-($edi,1)),=($edi,+($edi,1))))"}}, InstructionType::eStore},
			{X86_INS_STOSW, "stosw", {{2, "#seq(#st($mem,#arg[2],#arg[1]),?($df,=($edi,-($edi,2)),=($edi,+($edi,2))))"}}, InstructionType::eStore},
			{X86_INS_STOSD, "stosd", {{2, "#seq(#st($mem,#arg[2],#arg[1]),?($df,=($edi,-($edi,4)),=($edi,+($edi,4))))"}}, InstructionType::eStore},
			{X86_INS_STOSQ, "stosq", {{2, "#seq(#st($mem,#arg[2],#arg[1]),?($df,=($edi,-($edi,8)),=($edi,+($edi,8))))"}}, InstructionType::eStore},

			{X86_INS_STOSB | CUSOM_X86_INSTR_EXTR_REP, "rep stosb", {{2, "#rep($ecx,#seq(#rec[stosb](#arg[1],#arg[2]),=($ecx,-($ecx,1))))"}}, InstructionType::eStore},
			{X86_INS_STOSW | CUSOM_X86_INSTR_EXTR_REP, "rep stosw", {{2, "#rep($ecx,#seq(#rec[stosw](#arg[1],#arg[2]),=($ecx,-($ecx,1))))"}}, InstructionType::eStore},
			{X86_INS_STOSD | CUSOM_X86_INSTR_EXTR_REP, "rep stosd", {{2, "#rep($ecx,#seq(#rec[stosd](#arg[1],#arg[2]),=($ecx,-($ecx,1))))"}}, InstructionType::eStore},
			{X86_INS_STOSQ | CUSOM_X86_INSTR_EXTR_REP, "rep stosq", {{2, "#rep($ecx,#seq(#rec[stosq](#arg[1],#arg[2]),=($ecx,-($ecx,1))))"}}, InstructionType::eStore},

			{X86_INS_CMPSB, "cmpsb", {{2, "#seq(#rec[cmp](#arg[1],#arg[2]),=($edi,?($df,+($edi,1),-($edi,1))))"}}, InstructionType::eCmp},
			{X86_INS_CMPSW, "cmpsw", {{2, "#seq(#rec[cmp](#arg[1],#arg[2]),=($edi,?($df,+($edi,2),-($edi,2))))"}}, InstructionType::eCmp},
			{X86_INS_CMPSD, "cmpsd", {{2, "#seq(#rec[cmp](#arg[1],#arg[2]),=($edi,?($df,+($edi,4),-($edi,4))))"}}, InstructionType::eCmp},
			{X86_INS_CMPSQ, "cmpsq", {{2, "#seq(#rec[cmp](#arg[1],#arg[2]),=($edi,?($df,+($edi,8),-($edi,8))))"}}, InstructionType::eCmp},

			{X86_INS_CMPSB | CUSOM_X86_INSTR_EXTR_REPE, "repe cmpsb", {{2, "#seq(=($zf,1),#rep(#and($ecx,$zf),#seq(#rec[cmpsb](#arg[1],#arg[2]),=($ecx,-($ecx,1)))))"}}, InstructionType::eCmp},
			{X86_INS_CMPSW | CUSOM_X86_INSTR_EXTR_REPE, "repe cmpsw", {{2, "#seq(=($zf,1),#rep(#and($ecx,$zf),#seq(#rec[cmpsw](#arg[1],#arg[2]),=($ecx,-($ecx,1)))))"}}, InstructionType::eCmp},
			{X86_INS_CMPSD | CUSOM_X86_INSTR_EXTR_REPE, "repe cmpsd", {{2, "#seq(=($zf,1),#rep(#and($ecx,$zf),#seq(#rec[cmpsd](#arg[1],#arg[2]),=($ecx,-($ecx,1)))))"}}, InstructionType::eCmp},
			{X86_INS_CMPSQ | CUSOM_X86_INSTR_EXTR_REPE, "repe cmpsq", {{2, "#seq(=($zf,1),#rep(#and($ecx,$zf),#seq(#rec[cmpsq](#arg[1],#arg[2]),=($ecx,-($ecx,1)))))"}}, InstructionType::eCmp},

			{X86_INS_CMPSB | CUSOM_X86_INSTR_EXTR_REPNE, "repne cmpsb", {{2, "#seq(=($zf,0),#rep(#and($ecx,#not($zf)),#seq(#rec[cmpsb](#arg[1],#arg[2]),=($ecx,-($ecx,1)))))"}}, InstructionType::eCmp},
			{X86_INS_CMPSW | CUSOM_X86_INSTR_EXTR_REPNE, "repne cmpsw", {{2, "#seq(=($zf,0),#rep(#and($ecx,#not($zf)),#seq(#rec[cmpsw](#arg[1],#arg[2]),=($ecx,-($ecx,1)))))"}}, InstructionType::eCmp},
			{X86_INS_CMPSD | CUSOM_X86_INSTR_EXTR_REPNE, "repne cmpsd", {{2, "#seq(=($zf,0),#rep(#and($ecx,#not($zf)),#seq(#rec[cmpsd](#arg[1],#arg[2]),=($ecx,-($ecx,1)))))"}}, InstructionType::eCmp},
			{X86_INS_CMPSQ | CUSOM_X86_INSTR_EXTR_REPNE, "repne cmpsq", {{2, "#seq(=($zf,0),#rep(#and($ecx,#not($zf)),#seq(#rec[cmpsq](#arg[1],#arg[2]),=($ecx,-($ecx,1)))))"}}, InstructionType::eCmp},

			{X86_INS_SCASB, "scasb", {{2, "#seq(#rec[cmp](#arg[1],#arg[2]),?($df,=($edi,-($edi,1)),=($edi,+($edi,1))))"}}, InstructionType::eCmp},
			{X86_INS_SCASW, "scasw", {{2, "#seq(#rec[cmp](#arg[1],#arg[2]),?($df,=($edi,-($edi,2)),=($edi,+($edi,2))))"}}, InstructionType::eCmp},
			{X86_INS_SCASD, "scasd", {{2, "#seq(#rec[cmp](#arg[1],#arg[2]),?($df,=($edi,-($edi,4)),=($edi,+($edi,4))))"}}, InstructionType::eCmp},
			{X86_INS_SCASQ, "scasq", {{2, "#seq(#rec[cmp](#arg[1],#arg[2]),?($df,=($edi,-($edi,8)),=($edi,+($edi,8))))"}}, InstructionType::eCmp},

			{X86_INS_SCASB | CUSOM_X86_INSTR_EXTR_REPE, "repe scasb", {{2, "#seq(=($zf,1),#rep(#and($ecx,$zf),#seq(#rec[scasb](#arg[1],#arg[2]),=($ecx,-($ecx,1)))))"}}, InstructionType::eCmp},
			{X86_INS_SCASW | CUSOM_X86_INSTR_EXTR_REPE, "repe scasw", {{2, "#seq(=($zf,1),#rep(#and($ecx,$zf),#seq(#rec[scasw](#arg[1],#arg[2]),=($ecx,-($ecx,1)))))"}}, InstructionType::eCmp},
			{X86_INS_SCASD | CUSOM_X86_INSTR_EXTR_REPE, "repe scasd", {{2, "#seq(=($zf,1),#rep(#and($ecx,$zf),#seq(#rec[scasd](#arg[1],#arg[2]),=($ecx,-($ecx,1)))))"}}, InstructionType::eCmp},
			{X86_INS_SCASQ | CUSOM_X86_INSTR_EXTR_REPE, "repe scasq", {{2, "#seq(=($zf,1),#rep(#and($ecx,$zf),#seq(#rec[scasq](#arg[1],#arg[2]),=($ecx,-($ecx,1)))))"}}, InstructionType::eCmp},

			{X86_INS_SCASB | CUSOM_X86_INSTR_EXTR_REPNE, "repne scasb", {{2, "#seq(=($zf,0),#rep(#and($ecx,#not($zf)),#seq(#rec[scasb](#arg[1],#arg[2]),=($ecx,-($ecx,1)))))"}}, InstructionType::eCmp},
			{X86_INS_SCASW | CUSOM_X86_INSTR_EXTR_REPNE, "repne scasw", {{2, "#seq(=($zf,0),#rep(#and($ecx,#not($zf)),#seq(#rec[scasw](#arg[1],#arg[2]),=($ecx,-($ecx,1)))))"}}, InstructionType::eCmp},
			{X86_INS_SCASD | CUSOM_X86_INSTR_EXTR_REPNE, "repne scasd", {{2, "#seq(=($zf,0),#rep(#and($ecx,#not($zf)),#seq(#rec[scasd](#arg[1],#arg[2]),=($ecx,-($ecx,1)))))"}}, InstructionType::eCmp},
			{X86_INS_SCASQ | CUSOM_X86_INSTR_EXTR_REPNE, "repne scasq", {{2, "#seq(=($zf,0),#rep(#and($ecx,#not($zf)),#seq(#rec[scasq](#arg[1],#arg[2]),=($ecx,-($ecx,1)))))"}}, InstructionType::eCmp},
