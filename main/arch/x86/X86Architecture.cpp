...
//sw,cw,tw,fp_ip,...
	...
	{},//instructionIds
	{
		...
		{X86_INS_JE, "je", {{2, "#jmp(#arg[1],#arg[2],$zf)"}}, InstructionType::eCJmp},
		{X86_INS_JNE, "jne", {{2, "#jmp(#arg[1],#arg[2],#not($zf))"}}, InstructionType::eCJmp},
		{X86_INS_JA, "ja", {{2, "#jmp(#arg[1],#arg[2],#not(#or($cf,$zf)))"}}, InstructionType::eCJmp},
		{X86_INS_JAE, "jae", {{2, "#jmp(#arg[1],#arg[2],#not($cf))"}}, InstructionType::eCJmp},
		{X86_INS_JB, "jb", {{2, "#jmp(#arg[1],#arg[2],#not($cf))"}}, InstructionType::eCJmp},
		{X86_INS_JBE, "jbe", {{2, "#jmp(#arg[1],#arg[2],#or($cf,$zf))"}}, InstructionType::eCJmp},
		{X86_INS_JG, "jg", {{2, "#jmp(#arg[1],#arg[2],#and(#not($zf),==($sf,$of)))"}}, InstructionType::eCJmp},
		{X86_INS_JGE, "jge", {{2, "#jmp(#arg[1],#arg[2],==($sf,$of))"}}, InstructionType::eCJmp},
		{X86_INS_JL, "jl", {{2, "#jmp(#arg[1],#arg[2],<>($sf,$of))"}}, InstructionType::eCJmp},
		{X86_INS_JLE, "jle", {{2, "#jmp(#arg[1],#arg[2],#or($zf,<>($sf,$of)))"}}, InstructionType::eCJmp},
		{X86_INS_JO, "jo", {{2, "#jmp(#arg[1],#arg[2],$of)"}}, InstructionType::eCJmp},
		{X86_INS_JNO, "jno", {{2, "#jmp(#arg[1],#arg[2],#not($of))"}}, InstructionType::eCJmp},
		{X86_INS_JS, "js", {{2, "#jmp(#arg[1],#arg[2],$sf)"}}, InstructionType::eCJmp},
		{X86_INS_JNS, "jns", {{2, "#jmp(#arg[1],#arg[2],#not($sf))"}}, InstructionType::eCJmp},

		{X86_INS_JP, "jp", {{2, "#jmp(#arg[1],#arg[2],$pf)"}}, InstructionType::eCJmp},
		{X86_INS_JNP, "jnp", {{2, "#jmp(#arg[1],#arg[2],#not($pf))"}}, InstructionType::eCJmp},

		{X86_INS_JCXZ, "jcxz", {{2, "#jmp(#arg[1],#arg[2],#not($cx))"}}, InstructionType::eCJmp},
		{X86_INS_JECXZ, "jecxz", {{2, "#jmp(#arg[1],#arg[2],#not($ecx))"}}, InstructionType::eCJmp},
		{X86_INS_JRCXZ, "jrcxz", {{2, "#jmp(#arg[1],#arg[2],#not($rcx))"}}, InstructionType::eCJmp},
		...
		{X86_INS_SUB, "sub", {{2, "#seq(=(#arg[1],-(#arg[1],#arg[2])),=($of,#o),=($cf,#c),=($af,#c(4)),=($zf,==(#arg[1],0)),=($pf,$parity[u](#arg[1])),=($sf,<[s](#arg[1],0)))"}}, InstructionType::eSub},
